...
async function main() {
    ...
    switch (testType) {
        ...
        case 'getContentExceptions':
            return await getContentExceptions(); // TODO CCR add inputs here when we know what they are
        default:
...
async function getContentExceptions() {
    console.log(`\nCalling getContentExceptions`);
    const resp = await locallyInvokeGetContentExceptionsApi(); // TODO CCR add more arguments here when we know what they will be
