...
export class SpreadsheetDynamoTable {
    ...
    static async getItem(
        ...
        retailerId: number,
        categoryPath: string,
    ): Promise<SpreadsheetRecord | undefined> {
        ...
        return resp.Item
            ? createRecord(resp.Item as SpreadsheetDynamoRecord, {
                  supplierId,
                  retailerId,
                  categoryPath,
              })
     ...
     */
    static async markItemAsUpdated(
        supplierId: number,
        retailerId: number,
        categoryPath: string,
...
function extractFromFullPath(path: string): {
    retailerId: number;
    categoryPath: string;
} {
