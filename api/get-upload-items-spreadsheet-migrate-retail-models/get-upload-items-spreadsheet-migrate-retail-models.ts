...
import {
    ItemsUploadMigrateRetailModelSpreadsheetS3Metadata,
    createCatalogItemS3UploadPath,
    getSignedS3UploadUrlMigrateRetailModel,
} from '@lib/s3';
...
export const getUploadItemsSpreadsheetMigrateRetailModelsUrl =
    apiWrapper<GetUploadItemsSpreadsheetMigrateRetailModelsRequest>(async (event) => {
